...
import {
  ...
  ANNANDALE_CONFIG,
  FALLS_CHURCH_CONFIG,
  ALEXANDRIA_VA_CONFIG,
  SPRINGFIELD_VA_CONFIG,
  HERNDON_CONFIG,
  RESTON_CONFIG,
  STERLING_VA_CONFIG,
  VIENNA_VA_CONFIG,
  MANASSAS_CONFIG,
  WOODBRIDGE_VA_CONFIG,
  DUMFRIES_CONFIG,
  VIRGINIA_BEACH_CONFIG,
  NORFOLK_VA_CONFIG,
  CHESAPEAKE_VA_CONFIG,
  PORTSMOUTH_VA_CONFIG,
  NEWPORT_NEWS_CONFIG,
  SUFFOLK_VA_CONFIG,
  WILLIAMSBURG_VA_CONFIG,
  RICHMOND_VA_CONFIG,
  NORTH_CHESTERFIELD_CONFIG,
  FREDERICKSBURG_VA_CONFIG,
  CHARLOTTESVILLE_VA_CONFIG,
  HARRISONBURG_VA_CONFIG,
  WINCHESTER_VA_CONFIG,
  ROANOKE_VA_CONFIG,
  LYNCHBURG_VA_CONFIG,
  CHRISTIANSBURG_VA_CONFIG,
  DANVILLE_VA_CONFIG,
  FARMVILLE_VA_CONFIG,
  ABINGDON_VA_CONFIG,
  GALAX_VA_CONFIG,
...
export const CITIES: CityConfig[] = [
  ...
  SCHAUMBURG_CONFIG,
  NAPERVILLE_CONFIG,
  // Virginia — Northern Virginia (Korean community corridor)
  FAIRFAX_VA_CONFIG,
  ANNANDALE_CONFIG,
  FALLS_CHURCH_CONFIG,
  ALEXANDRIA_VA_CONFIG,
