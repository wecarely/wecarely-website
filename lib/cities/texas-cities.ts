/**
 * Bulk Texas city configs — smaller markets (10–50 agencies).
 * All have empty neighborhoods arrays for now; add sub-areas as needed.
 * To launch a city: set status → 'live' after running city_pipeline.py.
 */
import type { CityConfig } from './index';

export const ARLINGTON_CONFIG: CityConfig = {
  slug: 'arlington',
  name: 'Arlington',
  state: 'TX',
  status: 'coming-soon',
...
export const MESQUITE_CONFIG: CityConfig = {
  slug: 'mesquite',
  name: 'Mesquite',
  state: 'TX',
  status: 'coming-soon',
...
export const LAREDO_CONFIG: CityConfig = {
  slug: 'laredo',
  name: 'Laredo',
  state: 'TX',
  status: 'coming-soon',
...
export const MCALLEN_CONFIG: CityConfig = {
  slug: 'mcallen',
  name: 'McAllen',
  state: 'TX',
  status: 'coming-soon',
...
export const SUGAR_LAND_CONFIG: CityConfig = {
  slug: 'sugar-land',
  name: 'Sugar Land',
  state: 'TX',
  status: 'coming-soon',
...
export const CORPUS_CHRISTI_CONFIG: CityConfig = {
  slug: 'corpus-christi',
  name: 'Corpus Christi',
  state: 'TX',
  status: 'coming-soon',
...
export const STAFFORD_CONFIG: CityConfig = {
  slug: 'stafford',
  name: 'Stafford',
  state: 'TX',
  status: 'coming-soon',
...
export const IRVING_CONFIG: CityConfig = {
  slug: 'irving',
  name: 'Irving',
  state: 'TX',
  status: 'coming-soon',
...
export const KATY_CONFIG: CityConfig = {
  slug: 'katy',
  name: 'Katy',
  state: 'TX',
  status: 'coming-soon',
...
export const RICHMOND_CONFIG: CityConfig = {
  slug: 'richmond',
  name: 'Richmond',
  state: 'TX',
  status: 'coming-soon',
...
export const MISSOURI_CITY_CONFIG: CityConfig = {
  slug: 'missouri-city',
  name: 'Missouri City',
  state: 'TX',
  status: 'coming-soon',
...
export const GRAND_PRAIRIE_CONFIG: CityConfig = {
  slug: 'grand-prairie',
  name: 'Grand Prairie',
  state: 'TX',
  status: 'coming-soon',
...
export const BROWNSVILLE_CONFIG: CityConfig = {
  slug: 'brownsville',
  name: 'Brownsville',
  state: 'TX',
  status: 'coming-soon',
...
export const TYLER_CONFIG: CityConfig = {
  slug: 'tyler',
  name: 'Tyler',
  state: 'TX',
  status: 'coming-soon',
...
export const LEWISVILLE_CONFIG: CityConfig = {
  slug: 'lewisville',
  name: 'Lewisville',
  state: 'TX',
  status: 'coming-soon',
...
export const BEAUMONT_CONFIG: CityConfig = {
  slug: 'beaumont',
  name: 'Beaumont',
  state: 'TX',
  status: 'coming-soon',
...
export const LUBBOCK_CONFIG: CityConfig = {
  slug: 'lubbock',
  name: 'Lubbock',
  state: 'TX',
  status: 'coming-soon',
...
export const LONGVIEW_CONFIG: CityConfig = {
  slug: 'longview',
  name: 'Longview',
  state: 'TX',
  status: 'coming-soon',
...
export const EDINBURG_CONFIG: CityConfig = {
  slug: 'edinburg',
  name: 'Edinburg',
  state: 'TX',
  status: 'coming-soon',
...
export const WICHITA_FALLS_CONFIG: CityConfig = {
  slug: 'wichita-falls',
  name: 'Wichita Falls',
  state: 'TX',
  status: 'coming-soon',
...
export const HARLINGEN_CONFIG: CityConfig = {
  slug: 'harlingen',
  name: 'Harlingen',
  state: 'TX',
  status: 'coming-soon',
...
export const ALICE_CONFIG: CityConfig = {
  slug: 'alice',
  name: 'Alice',
  state: 'TX',
  status: 'coming-soon',
...
export const SHERMAN_CONFIG: CityConfig = {
  slug: 'sherman',
  name: 'Sherman',
  state: 'TX',
  status: 'coming-soon',
...
export const ROUND_ROCK_CONFIG: CityConfig = {
  slug: 'round-rock',
  name: 'Round Rock',
  state: 'TX',
  status: 'coming-soon',
...
export const LUFKIN_CONFIG: CityConfig = {
  slug: 'lufkin',
  name: 'Lufkin',
  state: 'TX',
  status: 'coming-soon',
...
export const AMARILLO_CONFIG: CityConfig = {
  slug: 'amarillo',
  name: 'Amarillo',
  state: 'TX',
  status: 'coming-soon',
...
export const WESLACO_CONFIG: CityConfig = {
  slug: 'weslaco',
  name: 'Weslaco',
  state: 'TX',
  status: 'coming-soon',
...
export const DUNCANVILLE_CONFIG: CityConfig = {
  slug: 'duncanville',
  name: 'Duncanville',
  state: 'TX',
  status: 'coming-soon',
